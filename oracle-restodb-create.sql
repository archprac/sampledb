...
CREATE INDEX restodb.products_idx1 ON restodb.products (product_name);
...
CREATE INDEX restodb.customers_idx1 ON restodb.customers (customer_last_name, customer_first_name);
...
CREATE INDEX restodb.orderer_reserves_idx1 ON restodb.orderer_reserves (orderer_id);
...
CREATE INDEX restodb.orderer_visits_idx1 ON restodb.orderer_visits (orderer_id, seat_id);
...
CREATE INDEX restodb.staffs_idx1 ON restodb.staffs (staff_last_name, staff_first_name);
...
CREATE INDEX restodb.rolls_idx1 ON restodb.rolls (roll_name);
...
CREATE INDEX restodb.staff_rolls_idx1 ON restodb.staff_rolls (staff_id, roll_id);
